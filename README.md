...
## Για την υλοποίηση του project χρησιμοποιήθηκε ως βάση δεδομένων η mongo DB και το γραφικό της περιβάλλον compass
...
```bash 
	make TARGET=sky PORT= /den/ttyUSB0 serialdump > out_pipe 
```
